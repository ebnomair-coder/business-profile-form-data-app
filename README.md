...
| #   | القسم                 | الحقول                                        | نوغ الحقول |
| --- | --------------------- | --------------------------------------------- | ---------- |
| 1   | **البيانات الأساسية** | الاسم التجاري، رقم الهاتف                   | اجباري     |
| 2   | **حساب Gmail**        | بريد Gmail لربط ملكية الملف التجاري           | اختياري    |
| 3   | **نبذة عن النشاط**    | وصف مبسط للخدمات (يتم صياغته تسويقياً لاحقاً) | اجباري     |
| 4   | **العنوان الدقيق**    | المدينة، الشارع، الرقم البريدي للمنطقة        | اجباري     |
| 2   | **الصور والشعار**     |                                               |            |
